...
Deno.test({
  name: "BaoStockApi.query_history_k_data_plus", fn: async () => {
    ...
    console.log(s)
    //日线指标参数（包含停牌证券）
    // const param="code,date,open,high,low,close,preclose,volume,amount,adjustflag,turn,tradestatus,pctChg,isST";
    //周、月线指标参数
    //  const param = "code,date,open,high,low,close,volume,amount,adjustflag,turn,pctChg";
